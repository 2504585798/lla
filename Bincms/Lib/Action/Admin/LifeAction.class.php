...
class LifeAction extends CommonAction {
    ...
    private $create_fields = array('title', 'cate_id', 'area_id', 'business_id', 'user_id', 'is_shop', 'text1', 'text2', 'text3', 'num1', 'num2', 'select1', 'select2', 'select3', 'select4', 'select5', 'urgent_date', 'top_date', 'photo', 'contact', 'mobile', 'qq', 'addr', 'views', 'lng', 'lat');
    private $edit_fields = array('title', 'cate_id', 'area_id', 'business_id', 'user_id', 'is_shop', 'text1', 'text2', 'text3', 'num1', 'num2', 'select1', 'select2', 'select3', 'select4', 'select5', 'urgent_date', 'top_date', 'photo', 'contact', 'mobile', 'qq', 'addr', 'views', 'lng', 'lat');
