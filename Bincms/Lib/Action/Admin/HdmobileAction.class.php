...
class HdmobileAction extends CommonAction {
    ...
    public function createCheck() {
        $data = $this->checkFields($this->_post('data', false), array('title', 'addr', 'time', 'user_id', 'intro', 'sex', 'photo', 'cate_id', 'shop_id', 'lat', 'lng'));
        $data['shop_id'] = (int) $data['shop_id'];
        $detail = D('Shop')->find($data['shop_id']);
        $data['lng'] = $detail['lng'];
        $data['lat'] = $detail['lat'];
    ...
    private function editCheck() {
        $data = $this->checkFields($this->_post('data', false), array('title', 'addr', 'intro', 'sex', 'photo', 'time', 'cate_id', 'shop_id', 'user_id'));
