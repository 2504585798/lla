...
class GoodsAction extends CommonAction {
    ...
    private $create_fields = array('title','intro','guige', 'num','shop_id', 'photo', 'cate_id', 'price', 'select1', 'select2', 'select3', 'select4', 'select5', 'mall_price','settlement_price','use_integral','mobile_fan', 'commission', 'sold_num', 'orderby', 'views', 'instructions', 'details', 'end_date', 'orderby','is_vs1','is_vs2','is_vs3','is_vs4','is_vs5',
	'is_vs6',);
    private $edit_fields = array('title','intro','guige','num', 'shop_id', 'photo', 'cate_id', 'price','select1', 'select2', 'select3', 'select4', 'select5',  'mall_price','settlement_price','use_integral','mobile_fan', 'commission', 'sold_num', 'orderby', 'views', 'instructions', 'details', 'end_date', 'orderby','is_vs1','is_vs2','is_vs3','is_vs4','is_vs5',
	'is_vs6',);
