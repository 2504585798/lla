...
class CommunityAction extends CommonAction {
    ...
    private $create_fields = array('name', 'addr', 'tel', 'pic','user_id','city_id', 'area_id', 'property', 'lng', 'lat', 'orderby');
    private $edit_fields = array('name', 'addr', 'tel', 'pic','user_id','city_id', 'area_id', 'property', 'lng', 'lat', 'orderby');
