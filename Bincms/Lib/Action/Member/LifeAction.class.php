...
class LifeAction extends CommonAction {
    ...
    public function lifetop() {
        ...
        if ($this->member['gold'] < $gold) {
            $this->baoErrorJump('金块余额不足', U('money/gold'));
        }
        ...
        if (D('Users')->addGold($this->uid, -$gold, '置顶信息' . $day . '天')) {
            ...
            $this->baoSuccess('您的信息已经在同频道置顶了！', U('member/life/index'));
        }
    ...
    public function lifeflush() {
        ...
        if (D('Life')->save($data)) {
            $this->baoSuccess('刷新成功!', U('member/life/index'));
        }
        $this->baoError('操作失败');
    }
    ...
    public function lifeurgent() {
        ...
        if ($this->member['gold'] < $gold) {
            $this->baoErrorJump('金块余额不足', U('member/money/gold'));
        }
        ...
        if (D('Users')->addGold($this->uid, -$gold, '加急信息' . $day . '天')) {
            ...
            $this->baoSuccess('您的信息已经加急！', U('member/life/index'));
        }
